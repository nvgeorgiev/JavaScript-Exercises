...
window.addEventListener('load', () => {
  ...
  async function getForecast() {
    ...
    tempSpan.innerHTML = `${today.forecast.low}${symbols.Degress}/${today.forecast.high}${symbols.Degress}`;
    ...
    const forecastInfoDiv = el('div', upcoming.forecast.map(renderUpcoming), {
